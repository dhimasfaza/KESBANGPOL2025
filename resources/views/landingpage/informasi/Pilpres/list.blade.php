{{-- Simpan di: resources/views/landingpage/informasi/pemilu/list.blade.php --}}
...
<div class="container py-5">
    <div class="row text-center mb-5">
        <div class="col">
            ...
            <p class="lead text-muted">Tahun {{ $paslons->first()->tahun_pemilu ?? 'Tidak Diketahui' }}</p>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card candidate-card h-100">
                ...
                <img src="{{ asset('storage/' . str_replace('public/', '', $paslon->capres_foto)) }}" class="card-img-top" alt="Foto {{ $paslon->capres_nama }}">
