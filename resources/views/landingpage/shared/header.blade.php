        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="dropdown-submenu dropend-left">
              ...
              <ul class="submenu dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('pemilu.show', 'presiden') }}">Pemilihan Presiden</a></li>
                <li><a class="dropdown-item" href="{{ route('pemilu.show', 'kepala-daerah') }}">Pemilihan Kepala Daerah</a></li>
