...
<div class="container-fluid">
    ...
    <div class="card">  
        <div class="card-body">
            {{-- PERBAIKAN 1: Form action sekarang mengarah ke pilpres.store --}}
            <form action="{{ route('pilpres.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<div class="form-group">
    ...
    <small>Gunakan tanda hubung (-) atau angka (1.) untuk membuat daftar poin.</small>
                ...
                <div class="mt-3">
                    ...
                    {{-- PERBAIKAN 2: Tombol Batal sekarang mengarah ke pilpres.index --}}
                    <a href="{{ route('pilpres.index') }}" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
