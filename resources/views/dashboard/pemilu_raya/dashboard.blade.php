            ...
            <div class="card shadow-lg border-0 h-100 hover-card">
                ...
                <div class="card-body text-center d-flex flex-column">
                    ...
                    <div class="mt-auto">
                        ...
                        <a href="{{ route('pilpres.index') }}" class="btn btn-danger btn-lg btn-block shadow-sm">
            ...
            <div class="card shadow-lg border-0 h-100 hover-card">
                ...
                <div class="card-body text-center d-flex flex-column">
                    ...
                    <div class="mt-auto">
                        ...
                        <a href="{{ route('walikota.index') }}" class="btn btn-danger btn-lg btn-block shadow-sm">
                            <i class="fas fa-arrow-right mr-2"></i>
                            Masuk
                        </a>
                    </div>
