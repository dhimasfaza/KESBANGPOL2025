...
Route::middleware(['auth'])->group(function () {
    ...
    // Route untuk CRUD Pilpres
    Route::get('/pemilu-raya', [PemiluRayaController::class, 'index'])->name('pemilu-raya.dashboard');
    Route::resource('/pilpres', PilpresController::class)->parameter('pilpres', 'paslon');

    // Route untuk CRUD Wali Kota
    Route::resource('/walikota', WalikotaController::class)->parameter('walikota', 'paslon');
});
