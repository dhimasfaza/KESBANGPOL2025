    ...
    <div class="row">
            ...
            <div class="card shadow-lg border-0 h-100 hover-card">
                ...
                <div class="card-body text-center d-flex flex-column">
                    ...
                    <div class="mt-auto">
                        ...
                        <a href="<?php echo e(route('pilpres.index')); ?>" class="btn btn-danger btn-lg btn-block shadow-sm">
            ...
            <div class="card shadow-lg border-0 h-100 hover-card">
                ...
                <div class="card-body text-center d-flex flex-column">
                    ...
                    <div class="mt-auto">
                        ...
                        <a href="<?php echo e(route('walikota.index')); ?>" class="btn btn-danger btn-lg btn-block shadow-sm">
                            <i class="fas fa-arrow-right mr-2"></i>
                            Masuk
                        </a>
                    </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card shadow-lg border-0 h-100 hover-card">
                ...
                <div class="card-body text-center d-flex flex-column">
                    <p class="card-text flex-grow-1 text-muted">
                        Kelola data calon anggota legislatif Dewan Perwakilan Rakyat Daerah.
                    </p>
                    <div class="mt-auto">
                        <div class="mb-3">
                        ...
                        <a href="#" class="btn btn-outline-danger btn-lg btn-block shadow-sm disabled">
...
<?php echo $__env->make('dashboard.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhimas Faza\Documents\Kuliah\Semester 6\MAGANG\WEBSITE-KESBANGPOL\KESBANGPOL2025\resources\views/dashboard/pemilu_raya/dashboard.blade.php ENDPATH**/ ?>