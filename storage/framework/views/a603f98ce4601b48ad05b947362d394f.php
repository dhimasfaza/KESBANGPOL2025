...
<div class="container-fluid">
    <h3>Tambah Paslon Pilpres Baru</h3>
    
    <div class="card">  
        <div class="card-body">
            
            <form action="<?php echo e(route('pilpres.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <input type="number" name="no_urut" class="form-control <?php $__errorArgs = ['no_urut'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no_urut')); ?>" required>
                        <?php $__errorArgs = ['no_urut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="number" name="tahun_pemilu" class="form-control" value="<?php echo e(old('tahun_pemilu', date('Y'))); ?>" required>
                    </div>
                     <div class="col-md-4 form-group">
                        <label for="partai_pengusung">Partai Pengusung</label>
                        <input type="text" name="partai_pengusung" class="form-control" value="<?php echo e(old('partai_pengusung')); ?>" required>
                    </div>
                </div>
...
<div class="form-group">
    ...
    <textarea name="visi" class="form-control" rows="4"><?php echo e(old('visi', $paslon->visi ?? '')); ?></textarea>
</div>
<div class="form-group">
    <label for="misi">Misi</label>
    <textarea name="misi" class="form-control" rows="8"><?php echo e(old('misi', $paslon->misi ?? '')); ?></textarea>
    <small>Gunakan tanda hubung (-) atau angka (1.) untuk membuat daftar poin.</small>
                ...
                <div class="mt-3">
                    ...
                    <a href="<?php echo e(route('pilpres.index')); ?>" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('dashboard.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhimas Faza\Documents\Kuliah\Semester 6\MAGANG\WEBSITE-KESBANGPOL\KESBANGPOL2025\resources\views/dashboard/pemilu_raya/pilpres/create.blade.php ENDPATH**/ ?>