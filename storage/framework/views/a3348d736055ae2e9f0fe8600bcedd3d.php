        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card border-0 shadow-sm rounded">
                    ...
                    <?php endif; ?>
                        <a href="<?php echo e(route('mitras.create')); ?>" class="btn-tambah-konten">
                            ...
                            <table class="table table-hover align-middle text-center">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $mitras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="fw-semibold"><?php echo e($mitra->kategori_mitra); ?></td>
                                            <td>
                                                <img src="<?php echo e(asset('images/mitras/logo/'.$mitra->logo_lembaga)); ?>" alt="<?php echo e($mitra->nama_lembaga); ?>" class="img-thumbnail" style="width: 120px; height: auto;">
                                            </td>
                                            <td class="fw-semibold"><?php echo e($mitra->nama_lembaga); ?></td>
                                            <td class="text-start"><?php echo Str::limit(strip_tags($mitra->alamat), 100, '...'); ?></td>
                                            <td class="text-start"><?php echo Str::limit(strip_tags($mitra->deskripsi), 100, '...'); ?></td>
                                            <td class="fw-semibold"><?php echo e($mitra->ketua); ?></td>
                                            <td>
                                                <img src="<?php echo e(asset('images/mitras/foto_ketua/'.$mitra->foto_ketua)); ?>" alt="<?php echo e($mitra->ketua); ?>" class="img-thumbnail" style="width: 120px; height: auto;">
                                            </td>
                                            <td class="fw-semibold"><?php echo e($mitra->kontak); ?></td>
                                            <td class="kolom-aksi text-center">
                                                <a href="<?php echo e(route('mitras.edit', $mitra->id)); ?>" class="btn btn-sm btn-warning">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="<?php echo e(route('mitras.destroy', $mitra->id)); ?>" method="POST" class="d-inline"
                        ...
                        <?php echo e($mitras->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('dashboard.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhimas Faza\Documents\Kuliah\Semester 6\MAGANG\WEBSITE-KESBANGPOL\KESBANGPOL2025\resources\views/dashboard/mitras/index.blade.php ENDPATH**/ ?>