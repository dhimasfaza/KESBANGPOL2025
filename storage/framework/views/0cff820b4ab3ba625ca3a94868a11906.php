<?php $__env->startSection('title', 'Laporan Akuntanbilitas Kinerja Instansi Pemerintahan'); ?>
    ...
    <div class="main-container">
        <div class="content-wrapper">
                    ...
                    <div class="table-container">
                        <table class="lakip-table">
                            ...
                            <tbody id="lakipTableBody">
                                <?php $__empty_1 = true; $__currentLoopData = $lakips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lakip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="lakip-item table-row" data-year="<?php echo e($lakip->tahun); ?>" data-title="<?php echo e($lakip->title); ?>" data-index="<?php echo e($index + 1); ?>">
                                    <td class="item-number table-cell-number">
                                        <span class="row-number"><?php echo e($index + 1); ?></span>
                                    </td>
                                    <td class="table-cell-year">
                                        <span class="badge badge-year"><?php echo e($lakip->tahun); ?></span>
                                    </td>
                                    <td class="table-cell-title">
                                        <div class="document-title"><?php echo e($lakip->title); ?></div>
                                    </td>
                                    <td class="table-cell-actions">
                                        <div class="action-buttons">
                                            <button type="button" class="btn btn-preview preview-btn" 
                                                    ...
                                                    data-file="<?php echo e(basename($lakip->file_upload)); ?>" 
                                                    data-download-url="<?php echo e(asset($lakip->file_upload_wm)); ?>"
                                                    data-title="<?php echo e($lakip->title); ?>">
                                                <i class="fas fa-eye"></i>
                                                <span class="btn-text">Preview</span>
                                            </button>
                                            <a href="<?php echo e(asset($lakip->file_upload_wm)); ?>" class="btn btn-download" download>
            ...
            <div class="pagination-wrapper">
                <?php echo e($lakips->links('pagination::bootstrap-5')); ?>
        ...
        <div class="container">
            <div class="page-share p-3 rounded shadow-sm" style="background: #ffffff;">
                ...
                <div class="share-options d-flex gap-3">
                    ...
                    <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->fullUrl())); ?>&text=<?php echo e(urlencode('Laporan AKIP Badan Kesatuan Bangsa dan Politik Kota Bandung')); ?>" 
                        target="_blank" class="share-icon twitter" title="Bagikan ke Twitter">
                        <i class="fab fa-x-twitter"></i>
                    </a>
                    <a href="https://api.whatsapp.com/send?text=<?php echo e(urlencode('Laporan AKIP Badan Kesatuan Bangsa dan Politik Kota Bandung')); ?>%20<?php echo e(urlencode(request()->fullUrl())); ?>" 
                        target="_blank" class="share-icon whatsapp" title="Bagikan ke WhatsApp">
                        <i class="fab fa-whatsapp"></i>
                    </a>
                    <a href="mailto:?subject=<?php echo e(urlencode('Laporan AKIP Badan Kesatuan Bangsa dan Politik Kota Bandung')); ?>&body=<?php echo e(urlencode('Saya ingin berbagi halaman menarik ini: ' . request()->fullUrl())); ?>" 
...
<?php echo $__env->make('landingpage.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Magang\KESBANGPOL2025\resources\views/landingpage/sakip/lakip.blade.php ENDPATH**/ ?>