<?php $__env->startSection('title', 'Banner Landing Page'); ?>
        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card border-0 shadow-sm rounded">
                    ...
                    <?php endif; ?>
                        <a href="<?php echo e(route('banners.create')); ?>" class="btn-tambah-konten">
                            ...
                            <table class="table table-hover align-middle text-center">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <img src="<?php echo e(asset('images/banner/'.$banner->gambar_upload)); ?>" alt="<?php echo e($banner->judul); ?>" class="img-thumbnail" style="width: 120px; height: auto;">
                                            </td>
                                            <td class="fw-semibold"><?php echo e($banner->judul); ?></td>
                                            <td class="text-start">
...
<?php echo $__env->make('dashboard.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KP Semester 6\KESBANGPOL2025\resources\views/dashboard/banners/index.blade.php ENDPATH**/ ?>