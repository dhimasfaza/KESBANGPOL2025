<?php $__env->startSection('title', 'Potensi Konflik di Kota Bandung'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/landingpage-potensikonflik.css')); ?>">
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-number" id="totalKonflik"><?php echo e(count($potensiKonfliks)); ?></div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-number" id="totalKecamatan"><?php echo e(count($statistikKecamatan)); ?></div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-number" id="totalKategori"><?php echo e(count($statistikKategori)); ?></div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-number" id="konflikAktif">
                        <?php echo e($potensiKonfliks->where('status', 'aktif')->count()); ?>
            ...
            <div class="table-container">
                ...
                <div style="overflow-x: auto;">
                    <table class="modern-table" id="dataTable">
                        ...
                        <tbody id="tableBody">
                            <?php $__currentLoopData = $potensiKonfliks1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-year="<?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('Y')); ?>">
                                <td><strong><?php echo e($item->nama_potensi); ?></strong></td>
                                <td><?php echo e($item->kategori); ?></td>
                                <td><?php echo e($item->lokasi_kecamatan); ?></td>
                                <td><?php echo e($item->lokasi_kelurahan); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d M Y')); ?></td>
                                <td>
                                    <span class="tingkat-badge tingkat-<?php echo e(strtolower($item->tingkat_potensi)); ?>">
                                        <?php echo e($item->tingkat_potensi); ?>
                ...
                <div class="pagination-section">
                    <?php echo e($potensiKonfliks1->links('components.custom-pagination')); ?>
        ...
        <div class="container">
            <div class="page-share p-3 rounded shadow-sm" style="background: #ffffff;">
                ...
                <div class="share-options d-flex gap-3">
                    ...
                    <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->fullUrl())); ?>&text=<?php echo e(urlencode('Data Potensi Konflik di Kota Bandung')); ?>" 
                        target="_blank" class="share-icon twitter" title="Bagikan ke Twitter">
                        <i class="fab fa-x-twitter"></i>
                    </a>
                    <a href="https://api.whatsapp.com/send?text=<?php echo e(urlencode('Data Potensi Konflik di Kota Bandung')); ?>%20<?php echo e(urlencode(request()->fullUrl())); ?>" 
                        target="_blank" class="share-icon whatsapp" title="Bagikan ke WhatsApp">
                        <i class="fab fa-whatsapp"></i>
                    </a>
                    <a href="mailto:?subject=<?php echo e(urlencode('Data Potensi Konflik di Kota Bandung')); ?>&body=<?php echo e(urlencode('Saya ingin berbagi halaman menarik ini: ' . request()->fullUrl())); ?>" 
    ...
    <script>
        ...
        const potensiKonfliks = <?php echo json_encode($potensiKonfliks, 15, 512) ?>;
        const statistikKategori = <?php echo json_encode($statistikKategori, 15, 512) ?>;
        const statistikKecamatan = <?php echo json_encode($statistikKecamatan, 15, 512) ?>;
        const statistikTingkat = <?php echo json_encode($statistikTingkat, 15, 512) ?>;
        const statistikKelurahan = <?php echo json_encode($statistikKelurahan, 15, 512) ?>; // NEW: Data statistik per kelurahan
...
<?php echo $__env->make('landingpage.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhimas Faza\Documents\Kuliah\Semester 6\MAGANG\WEBSITE-KESBANGPOL\KESBANGPOL2025\resources\views/landingpage/informasi/potensi-konflik.blade.php ENDPATH**/ ?>