...
<?php $__env->startSection('title', $mitra->nama_lembaga); ?>
<link rel="stylesheet" href="<?php echo e(asset('assets/css/share-page.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('resources/css/landingpage-mitra.css')); ?>">
    ...
    <div class="header-top-row">
        ...
        <div class="mitra-logo-container">
            <div class="mitra-logo">
                <img src="<?php echo e(asset('images/mitras/logo/' . $mitra->logo_lembaga)); ?>" 
                     alt="Logo <?php echo e($mitra->nama_lembaga); ?>">
            </div>
        </div>
        
        <div class="mitra-title-info">
            <h2 class="mitra-name"><?php echo e($mitra->nama_lembaga); ?></h2>
            <span class="mitra-category-badge"><?php echo e($mitra->kategori_mitra); ?></span>
        </div>

    </div>
    <?php if($mitra->deskripsi): ?>
        <div class="mitra-description">
            <p><?php echo $mitra->deskripsi; ?></p>
        </div>
    <?php endif; ?>
</div>
                    </div>
                        ...
                        <div class="detail-card leadership-card">
                            ...
                            <div class="card-body">
                                <div class="leader-profile">
                                    <?php if($mitra->foto_ketua): ?>
                                        <div class="leader-photo">
                                            <img src="<?php echo e(asset('images/mitras/foto_ketua/' . $mitra->foto_ketua)); ?>" 
                                                 alt="Foto <?php echo e($mitra->ketua); ?>">
                                        </div>
                                    <?php endif; ?>
                                    <div class="leader-info">
                                        <h4 class="leader-name"><?php echo e($mitra->ketua); ?></h4>
                                        <p class="leader-position">Ketua <?php echo e($mitra->nama_lembaga); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="contact-list">
                                    <div class="contact-item">
                                        ...
                                        <div class="contact-info">
                                            ...
                                            <a href="tel:<?php echo e($mitra->kontak); ?>" class="contact-value"><?php echo e($mitra->kontak); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <?php if($mitra->alamat): ?>
                                    <div class="contact-item">
                                        ...
                                        <div class="contact-info">
                                            ...
                                            <span class="contact-value"><?php echo $mitra->alamat; ?></span>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div class="contact-item">
                ...
                <div class="back-navigation">
                    <a href="<?php echo e(route('tampilmitra')); ?>" class="back-btn">
...
<?php echo $__env->make('landingpage.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Magang\KESBANGPOL2025\resources\views/landingpage/mitra/detail.blade.php ENDPATH**/ ?>