        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card border-0 shadow-sm rounded">
                    ...
                    <?php endif; ?>
                        <a href="<?php echo e(route('posts.create')); ?>" class="btn-tambah-konten">
                            ...
                            <table class="table table-hover align-middle text-center">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <img src="<?php echo e(asset('images/posts/'.$post->image)); ?>" alt="<?php echo e($post->title); ?>" class="img-thumbnail" style="width: 120px; height: auto;">
                                            </td>
                                            <td class="fw-semibold"><?php echo e($post->title); ?></td>
                                            <td class="text-start"><?php echo Str::limit(strip_tags($post->content), 100, '...'); ?></td>
...
<?php echo $__env->make('dashboard.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KP Semester 6\KESBANGPOL2025\resources\views/dashboard/posts/index.blade.php ENDPATH**/ ?>