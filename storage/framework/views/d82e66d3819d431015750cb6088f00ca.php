...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?php echo e(route('walikota.create')); ?>" class="btn btn-primary">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('walikota.show', $paslon->id)); ?>" class="btn btn-sm btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                                    <a href="<?php echo e(route('walikota.edit', $paslon->id)); ?>" class="btn btn-sm btn-warning" title="Edit"><i class="fas fa-edit"></i></a>
                                    <form action="<?php echo e(route('walikota.destroy', $paslon->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhimas Faza\Documents\Kuliah\Semester 6\MAGANG\WEBSITE-KESBANGPOL\KESBANGPOL2025\resources\views/dashboard/pemilu_raya/walikota/index.blade.php ENDPATH**/ ?>