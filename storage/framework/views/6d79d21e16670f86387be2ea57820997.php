...
<?php $__env->startSection('title', 'Kategori: ' . ucwords(str_replace('-', ' ', strtolower($namaKategori)))); ?>
        ...
        <div class="container">
            <div class="mitra-grid" id="mitraGrid">
                <?php $__empty_1 = true; $__currentLoopData = $mitras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="mitra-card" data-name="<?php echo e(strtolower($mitra->nama_lembaga)); ?>">
                        <a href="<?php echo e(route('mitra.show.detail', $mitra->id)); ?>" class="card-link">
                            <div class="card-content">
                                <div class="card-header">
                                    <div class="logo-container">
                                        <?php if($mitra->logo_lembaga): ?>
                                ...
                                <div class="card-body">
                                    <h3 class="mitra-name"><?php echo e($mitra->nama_lembaga); ?></h3>
                                    <p class="mitra-leader">
                                        <i class="fas fa-user-tie"></i>
                                        <?php echo e($mitra->ketua); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('tampilmitra')); ?>" class="btn-primary">
            ...
            <?php if(count($mitras) > 0): ?>
                <div class="back-section">
                    <a href="<?php echo e(route('tampilmitra')); ?>" class="btn-back">
                        <i class="fas fa-arrow-left"></i>
                        Kembali ke Semua Mitra
                    </a>
                </div>
...
<?php echo $__env->make('landingpage.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Magang\KESBANGPOL2025\resources\views/landingpage/mitra/kategori.blade.php ENDPATH**/ ?>