<?php $__env->startSection('title', 'Halaman Beranda'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <section  class="hero">
        ...
        <div class="hero-container">
            ...
            <div class="hero-content">
                ...
                <form action="<?php echo e(route('semua-artikel')); ?>" method="GET" class="search-form fade-in" id="search-group">
            ...
            <div class="swiper-wrapper">
                <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide position-relative">
                        <img 
                            src="<?php echo e(asset('images/banner/' . $banner->gambar_upload)); ?>" 
                            class="d-block w-100" 
                            alt="<?php echo e($banner->judul); ?>"
                        >
                        <div class="carousel-caption text-center text-white custom-caption-center">
                            <h5><?php echo e($banner->judul); ?></h5>
                            <p><?php echo e($banner->caption); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="500" data-aos-duration="600">
                            <div class="layanan-box">
                                ...
                                <div class="text-end mt-3">
                                    <a href="<?php echo e(route('tampilmenuprofile')); ?>" class="layanan-link">
                                        Selengkapnya 
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="700" data-aos-duration="600">
                            <div class="layanan-box">
                                ...
                                <div class="text-end mt-3">
                                    <a href="<?php echo e(route('tampilmenusakip')); ?>" class="layanan-link">
                                        Selengkapnya 
                                        <span class="icon-wrapper">
                                            <i class="fas fa-arrow-right"></i>
                                        </span>
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="800" data-aos-duration="600">
                            <div class="layanan-box">
                                ...
                                <div class="text-end mt-3">
                                    <a href="<?php echo e(route('tampil-data-ormas')); ?>" class="layanan-link">
                                        Selengkapnya 
                                        <span class="icon-wrapper">
                                            <i class="fas fa-arrow-right"></i>
                                        </span>
    ...
    <section class="galeri-section">
        ...
        <div class="galeri-container" id="galeri-box" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
            <?php $__currentLoopData = $galeris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(asset('images/gallery/' . $item->gambar_upload)); ?>"
                    data-fancybox="gallery"
                    class="galeri-item <?php echo e($loop->index > 2 ? 'hidden' : ''); ?>">
                    <div class="galeri-card">
                        <div class="image-container">
                            <img src="<?php echo e(asset('images/gallery/' . $item->gambar_upload)); ?>"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const allPosts = <?php echo json_encode($posts, 15, 512) ?>;
...
<?php echo $__env->make('landingpage.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhimas Faza\Documents\Kuliah\Semester 6\MAGANG\WEBSITE-KESBANGPOL\KESBANGPOL2025\resources\views/landingpage/beranda.blade.php ENDPATH**/ ?>